...
jQuery(document).ready(function ($) {
    ...
    $(document).on("click", ".btn-cite-trigger, .btn-cite-export", function (e) {
        e.preventDefault();
        currentPostId = $(this).data("post-id") \vert{}\vert{} $(this).data("id") || null;
        currentTitle  = $(this).data("title") \vert{}\vert{} $(this).closest("article").find("h1, h2").first().text().trim() || "Publication Citation";
...
$copyBtn.on("click", function () {
    ...
    $downloadBtn.on("click", function () {
        ...
        const filename = (currentTitle.replace(/[^a-z0-9]/gi, "_").toLowerCase().substring(0, 30) || "citation") + "." + ext;
